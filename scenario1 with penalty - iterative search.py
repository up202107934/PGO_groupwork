...
def move_patient(assignments, patients, df_rooms, df_surgeons, C_PER_SHIFT):
    ...
    # escolher 1 bloco aleatório (podes trocar por um critério mais esperto)
...
def local_search(assign_init, df_rooms, df_surgeons, patients,
    ...
    """
    Local search de first-improvement com vizinhança N₁ (mover 1 doente).
    Só mexe em variáveis discretas: (room, day, shift) dos doentes.
    """
